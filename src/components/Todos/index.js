...
export default class Todos extends Component {
	...
	render()
	    ...
	    const renderTodos = currentTodos.map((todo) => {
      		 return  (
               		<Todo todo={todo} handleChecked ={this.handleChecked.bind(this)} 
                		delete = {this.deleteTodo.bind(this, todo)} />
					)
    	});
    	const pageNumbers = [];
		            	...
		            	<div className="border1">
		            		<div className="border2">
	            				<div className="add-div" >
					            	<Button id="add-todo" type="primary"
					            		onClick={this.showModal}><Icon type="plus" />
					            	</Button>
							        <Modal
								        title="Add New Todo"
						            ...
						            <Input type="text" placeholder="Add New Todo" 
						            	...
						            	onChange={this._handleNewTodo.bind(this)}/>
                	...
                	<div className="border1">
                        <div className="border2">
                			<div className="button-div">
	                			{currentPage === 1
	                				?<Button onClick={this.handlePreviousClick} disabled>
	                					<span className="span"><Icon type="play-circle" /></span>previous</Button>
	                				:<Button onClick={this.handlePreviousClick}>
	                					<span className="span"><Icon type="play-circle" /></span>previous</Button>
	                			}
                				{currentPage === (pageNumbers.length) 
	                            	? <Button onClick={this.handleNextClick} disabled>Next
	                            		<Icon type="play-circle"  /></Button>
